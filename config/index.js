...
module.exports = {
    dev: {
        ...
        proxyTable: {
            ...
            '/api/getSingerDetail': { //根据歌手获取歌曲数据
            ...
            '/api/getLyric': {//获取歌词数据
                target: 'https://szc.y.qq.com/lyric/fcgi-bin/fcg_query_lyric.fcg',
                bypass: function (req, res, proxyOptions) {
            ...
            '/api/search': {//获取排行歌单数据
                ...
                bypass: function (req, res, proxyOptions) {
                    req.headers.referer = 'https://m.y.qq.com/';
                    req.headers.host = 'c.y.qq.com';
                },
                changeOrigin: true,
                pathRewrite: {
