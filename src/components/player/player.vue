    ...
    <div class="player" v-show="playList.length>0">
        ...
        <transition name="mini">
            <div class="mini-player" @click="open" v-show="!fullScreen">
                <div class="icon">
                    <img :class="cdCls" width="48" height="48" :src="currentSong.image" alt="">
                </div>
                <div class="text">
    ...
    export default {
        ...
        methods: {
            ...
            middleTouchMove(e) {
                ...
                this.touch.perent = Math.abs(offsetWidth / window.innerWidth);
                this.$refs.lyricList.$el.style[transform] = `translate3d(${offsetWidth}px,0,0)`;
                this.$refs.lyricList.$el.style[transionDuration] = 0 + 'ms';
            ...
            middleTouchEnd() {
                ...
                this.$refs.lyricList.$el.style[transform] = `translate3d(${offsetWidth}px,0,0)`;
                this.$refs.lyricList.$el.style[transionDuration] = 300 + 'ms';
